...
[![Latest Version on Packagist](https://img.shields.io/packagist/v/npa/ticarx-modules.svg?style=flat-square)](https://packagist.org/packages/npa/ticarx-modules)
[![Software License](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square)](LICENSE.md)
[![Scrutinizer Coverage](https://img.shields.io/scrutinizer/coverage/g/npa/ticarx-modules.svg?maxAge=86400&style=flat-square)](https://scrutinizer-ci.com/g/npa/ticarx-modules/?branch=master)
[![Total Downloads](https://img.shields.io/packagist/dt/npa/ticarx-modules.svg?style=flat-square)](https://packagist.org/packages/npa/ticarx-modules)
...
`npa/ticarx-modules` is a Laravel package created to manage your large Laravel app using modules. A Module is like a Laravel package, it has some views, controllers or models. This package is supported and tested in Laravel 11.
