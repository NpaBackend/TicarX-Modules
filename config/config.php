...
use TicarX\Modules\Activators\FileActivator;
...
return [
    ...
    */
    'stubs' => [
        'enabled' => false,
        'path' => base_path('vendor/npa/ticarx-modules/src/Commands/stubs'),
        'files' => [
    ...
    */
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'ticarx'),
        'author' => [
            'name' => env('MODULE_AUTHOR_NAME', 'Huseyn JavaDle'),
            'email' => env('MODULE_AUTHOR_EMAIL', 'huseynjavadle@gmail.com'),
        ],
