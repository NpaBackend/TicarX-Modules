...
use TicarX\Modules\Exceptions\InvalidAssetPath;
use TicarX\Modules\Exceptions\ModuleNotFoundException;
use TicarX\Modules\Process\Installer;
use TicarX\Modules\Process\Updater;
...
abstract class FileRepository implements RepositoryInterface, Countable
{
     ...
     * @return string
     * @throws \TicarX\Modules\Exceptions\ModuleNotFoundException
     */
