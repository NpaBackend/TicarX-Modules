...
use TicarX\Modules\Contracts\ActivatorInterface;
use TicarX\Modules\FileRepository;
use TicarX\Modules\Support\Config\GenerateConfigReader;
use TicarX\Modules\Support\Stub;
use TicarX\Modules\Traits\PathNamespace;
