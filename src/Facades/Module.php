...
namespace TicarX\Modules\Facades;
 ...
 * @method static \TicarX\Modules\Collection toCollection()
 ...
 * @method static \TicarX\Modules\Module find(string $name)
 * @method static \TicarX\Modules\Module findOrFail(string $name)
